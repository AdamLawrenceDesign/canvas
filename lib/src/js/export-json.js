...
ExportJson.prototype.init = function()
{
	...
	/*
		var cartValue, WebClientAssetId, productId, ImageUrl, imagePreview, ProductDescription, tempOriginUrl, ProductName, Price, Quantity, DiscountAmount, TotalAmount, WebDataItem, SICCode, WebClientID, PortalName;

	WebClientAssetId =  '4239';         											// THIS IS HARDCODED
