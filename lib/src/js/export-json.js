...
ExportJson.prototype.postToCart = function(jsons)
{
	...
	ImageUrl         = '~/CreateJS/JSON/' + jsons + '.jpg';         		// (a snip from the final design – or thumbnail from the webclientassetid or productId)
...
ExportJson.prototype.editCartItem = function()
{
	...
	$('header, aside').on('click', '.export', function()
	{
		...
		{					
			...
			console.log('Date for updating json strings: ', data)		
