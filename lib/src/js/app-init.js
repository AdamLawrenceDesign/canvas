...
AppInit.prototype.asideInit = function()
{
	...
	loadAssetsInit = new LoadAssets(this.website, this.userId, productData, images, textThemes, jsonObjs, function()
	{
		// START IMAGE UPLOADER 	STEP 14. 
		var imageUploader = new ImageUploader(this.userId, null, 'Guests', function()
			{
				...
				var addItemsInit = new AddItems(this.website, this.userId, productData, images, textThemes, jsonObjs); 
	...
	console.log(' userId: ', this.userId, ' userName:', this.userName, ' userName again: ', this.userInfo.firstName)
...
AppInit.prototype.init = function()
{
	...
	/*
	OLD WAY WHERE JSONS WERE CREATE USING THE LAYOUT ID
