...
AppInit.prototype.asideInit = function()
{
	...
	loadAssetsInit = new LoadAssets(this.website, this.userInfo, productData, images, textThemes, jsonObjs, function()
	{
		...
		var imageUploader = new ImageUploader(_this.userId, null, 'Guests', function()
			{
				...
				var addItemsInit = new AddItems(_this.website, _this.userId, productData, images, textThemes, jsonObjs); 
